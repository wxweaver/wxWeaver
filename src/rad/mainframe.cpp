...
wxToolBar* MainFrame::CreateWeaverToolBar()
{
    ...
    toolbar->AddTool(ID_ALIGN_RIGHT, "", AppBitmaps::GetBitmap("align-horizontal-right", TOOL_SIZE), wxNullBitmap, wxITEM_CHECK, _("Align Right"), _("The item will be aligned to the right of the space alotted to it by the sizer."));
    toolbar->AddSeparator();
    toolbar->AddTool(ID_ALIGN_TOP, "", AppBitmaps::GetBitmap("align-vertical-top", TOOL_SIZE), wxNullBitmap, wxITEM_CHECK, _("Align Top"), _("The item will be aligned to the top of the space alotted to it by the sizer."));
    toolbar->AddTool(ID_ALIGN_CENTER_V, "", AppBitmaps::GetBitmap("align-vertical-center", TOOL_SIZE), wxNullBitmap, wxITEM_CHECK, _("Align Center Vertically"), _("The item will be centered vertically within space alotted to it by the sizer."));
    toolbar->AddTool(ID_ALIGN_BOTTOM, "", AppBitmaps::GetBitmap("align-vertical-bottom", TOOL_SIZE), wxNullBitmap, wxITEM_CHECK, _("Align Bottom"), _("The item will be aligned to the bottom of the space alotted to it by the sizer."));
    toolbar->AddSeparator();
