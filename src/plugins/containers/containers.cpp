...
protected:
    ...
    void OnBookPageChanged(int selPage, wxEvent* event)
    {
        ...
        for (size_t i = 0; i < count; i++) {
            ...
            if (iChild) {
                if (selPage == (int)i && !iChild->GetPropertyAsInteger(_("select")))
...
public:
    ...
    {
        ObjectToXrcFilter xrc(obj, _("wxPanel"),
...
public:
    wxObject* Create(IObject* obj, wxObject* parent) override
    {
        ...
        collapsiblePane->Collapse(obj->GetPropertyAsInteger(_("collapsed")));
    ...
    ticpp::Element* ExportToXrc(IObject* obj) override
    {
        ObjectToXrcFilter xrc(obj, _("wxCollapsiblePane"),
                              obj->GetPropertyAsString(_("name")));
        xrc.AddWindowProperties();
...
void ComponentEvtHandler::OnCollapsiblePaneChanged(wxCollapsiblePaneEvent& event)
{
    ...
    m_manager->ModifyProperty(collapsiblePane, _("collapsed"), s);
...
class SplitterWindowComponent : public ComponentBase {
    ...
    ticpp::Element* ExportToXrc(IObject* obj) override
    {
        ObjectToXrcFilter xrc(obj, _("wxSplitterWindow"),
                              obj->GetPropertyAsString(_("name")));
        xrc.AddWindowProperties();
...
class SplitterItemComponent : public ComponentBase {
    ticpp::Element* ExportToXrc(IObject* obj) override
    {
        ...
        ObjectToXrcFilter xrc(obj, _("__dummyitem__"), "");
        return xrc.GetXrcObject();
    }
};
...
public:
    ...
    ticpp::Element* ExportToXrc(IObject* obj) override
    {
        ObjectToXrcFilter xrc(obj, _("wxScrolledWindow"),
                              obj->GetPropertyAsString(_("name")));
        xrc.AddWindowProperties();
    ...
    ticpp::Element* ImportFromXrc(ticpp::Element* xrcObj) override
    {
        ...
        if (scrollrate) {
            ...
            filter.AddPropertyValue(_("scroll_rate_x"), value.BeforeFirst(','));
            filter.AddPropertyValue(_("scroll_rate_y"), value.AfterFirst(','));
        }
        return filter.GetXfbObject();
    }
};
...
public:
    ...
    ticpp::Element* ExportToXrc(IObject* obj) override
    {
        ObjectToXrcFilter xrc(obj, _("wxNotebook"),
                              obj->GetPropertyAsString(_("name")));
        xrc.AddWindowProperties();
        return xrc.GetXrcObject();
    }
...
public:
    void OnCreated(wxObject* wxobject, wxWindow* wxparent) override
    {
        BookUtils::OnCreated<wxNotebook>(
            wxobject, wxparent, GetManager(), _("NotebookPageComponent"));
    }
...
// Small icon style not supported by GTK
    ...
    ticpp::Element* ExportToXrc(IObject* obj) override
    {
        ObjectToXrcFilter xrc(obj, _("wxListbook"),
                              obj->GetPropertyAsString(_("name")));
        xrc.AddWindowProperties();
        return xrc.GetXrcObject();
    }
...
public:
    void OnCreated(wxObject* wxobject, wxWindow* wxparent) override
    {
        BookUtils::OnCreated<wxListbook>(
            wxobject, wxparent, GetManager(), _("ListbookPageComponent"));
    }
...
public:
    ...
    ticpp::Element* ExportToXrc(IObject* obj) override
    {
        ObjectToXrcFilter xrc(obj, _("wxChoicebook"),
                              obj->GetPropertyAsString(_("name")));
        xrc.AddWindowProperties();
        return xrc.GetXrcObject();
    }
...
public:
    void OnCreated(wxObject* wxobject, wxWindow* wxparent) override
    {
        BookUtils::OnCreated<wxChoicebook>(
            wxobject, wxparent, GetManager(), _("ChoicebookPageComponent"));
    }
...
public:
    wxObject* Create(IObject* obj, wxObject* parent) override
    {
        ...
        auiNotebook->SetTabCtrlHeight(obj->GetPropertyAsInteger(_("tab_ctrl_height")));
        auiNotebook->SetUniformBitmapSize(obj->GetPropertyAsSize(_("uniform_bitmap_size")));
    ...
    ticpp::Element* ExportToXrc(IObject* obj) override
    {
        ObjectToXrcFilter xrc(obj, _("wxAuiNotebook"),
                              obj->GetPropertyAsString(_("name")));
        xrc.AddWindowProperties();
        return xrc.GetXrcObject();
    }
...
public:
    void OnCreated(wxObject* wxobject, wxWindow* wxparent) override
    {
        ...
        const wxBitmap& bitmap = obj->IsNull(_("bitmap"))
            ? wxNullBitmap
            : obj->GetPropertyAsBitmap(_("bitmap"));

        auiNotebook->AddPage(page, obj->GetPropertyAsString(_("label")), false, bitmap);

        if (obj->GetPropertyAsString(_("select")) == "0" && selection >= 0)
...
public:
    ...
    ticpp::Element* ExportToXrc(IObject* obj) override
    {
        ObjectToXrcFilter xrc(obj, _("wxSimplebook"),
                              obj->GetPropertyAsString(_("name")));
        xrc.AddWindowProperties();
        return xrc.GetXrcObject();
    }
...
public:
    void OnCreated(wxObject* wxobject, wxWindow* wxparent) override
    {
        BookUtils::OnCreated<wxSimplebook>(
            wxobject, wxparent, GetManager(), _("SimplebookPageComponent"));
    }
