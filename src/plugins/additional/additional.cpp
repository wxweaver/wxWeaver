...
public:
    ...
    {
        ObjectToXrcFilter xrc(obj, _("wxCalendarCtrl"),
...
public:
    ...
    ticpp::Element* ExportToXrc(IObject* obj) override
    {
        ObjectToXrcFilter xrc(obj, _("wxDatePickerCtrl"),
                              obj->GetPropertyAsString(_("name")));
        xrc.AddWindowProperties();
        return xrc.GetXrcObject();
    }
...
public:
    ...
    ticpp::Element* ExportToXrc(IObject* obj) override
    {
        ObjectToXrcFilter xrc(obj, _("wxTimePickerCtrl"),
                              obj->GetPropertyAsString(_("name")));
        xrc.AddWindowProperties();
        return xrc.GetXrcObject();
    }
...
public:
    wxObject* Create(IObject* obj, wxObject* parent) override
    {
        ...
        r.WriteText(
            wxT("Next, we'll show a first-line indent, achieved using BeginLeftIndent(100, -40)."));
    ...
    ticpp::Element* ExportToXrc(IObject* obj) override
    {
        ObjectToXrcFilter xrc(obj, _("wxRichTextCtrl"),
                              obj->GetPropertyAsString(_("name")));
        xrc.AddWindowProperties();
...
public:
    ...
    ticpp::Element* ExportToXrc(IObject* obj) override
    {
        ObjectToXrcFilter xrc(obj, _("wxHtmlWindow"),
                              obj->GetPropertyAsString(_("name")));
        xrc.AddWindowProperties();
        return xrc.GetXrcObject();
    }
...
public:
    wxObject* Create(IObject* obj, wxObject* parent) override
    {
        ...
        if (!obj->IsNull(_("bitmap")))
            toggleButton->SetBitmap(obj->GetPropertyAsBitmap(_("bitmap")));

        if (!obj->IsNull(_("disabled")))
            toggleButton->SetBitmapDisabled(obj->GetPropertyAsBitmap(_("disabled")));

        if (!obj->IsNull(_("pressed")))
            toggleButton->SetBitmapPressed(obj->GetPropertyAsBitmap(_("pressed")));

        if (!obj->IsNull(_("focus")))
            toggleButton->SetBitmapFocus(obj->GetPropertyAsBitmap(_("focus")));

        if (!obj->IsNull(_("current")))
            toggleButton->SetBitmapCurrent(obj->GetPropertyAsBitmap(_("current")));
        ...
        if (!obj->IsNull(_("margins")))
            toggleButton->SetBitmapMargins(obj->GetPropertyAsSize(_("margins")));

        toggleButton->SetValue((obj->GetPropertyAsInteger(_("value"))));
    ...
    ticpp::Element* ExportToXrc(IObject* obj) override
    {
        ObjectToXrcFilter xrc(obj, _("wxToggleButton"),
                              obj->GetPropertyAsString(_("name")));
        xrc.AddWindowProperties();
...
public:
    wxObject* Create(IObject* obj, wxObject* parent) override
    {
        ...
        if (obj->GetPropertyAsInteger(_("markup")))
            bmpToggleBtn->SetLabelMarkup(obj->GetPropertyAsString(_("label")));

        if (!obj->IsNull(_("disabled")))
            bmpToggleBtn->SetBitmapDisabled(obj->GetPropertyAsBitmap(_("disabled")));

        if (!obj->IsNull(_("pressed")))
            bmpToggleBtn->SetBitmapPressed(obj->GetPropertyAsBitmap(_("pressed")));

        if (!obj->IsNull(_("focus")))
            bmpToggleBtn->SetBitmapFocus(obj->GetPropertyAsBitmap(_("focus")));

        if (!obj->IsNull(_("current")))
            bmpToggleBtn->SetBitmapCurrent(obj->GetPropertyAsBitmap(_("current")));
        ...
        if (!obj->IsNull(_("margins")))
            bmpToggleBtn->SetBitmapMargins(obj->GetPropertyAsSize(_("margins")));

        bmpToggleBtn->SetValue((obj->GetPropertyAsInteger(_("value"))));
    ...
    void OnToggle(wxCommandEvent& event)
    {
        ...
        wxString value;
        value.Printf(wxT("%i"), bmpToggleBtn->GetValue() ? 1 : 0);
        GetManager()->ModifyProperty(bmpToggleBtn, _("value"), value);
        bmpToggleBtn->SetFocus();
    }

    ticpp::Element* ExportToXrc(IObject* obj) override
    {
        ObjectToXrcFilter xrc(obj, _("wxBitmapToggleButton"),
                              obj->GetPropertyAsString(_("name")));
        xrc.AddWindowProperties();
...
public:
    wxObject* Create(IObject* obj, wxObject* parent) override
    {
        ...
        // dummy nodes
        wxTreeItemId root = treeCtrl->AddRoot(wxT("root node"));
        wxTreeItemId node1 = treeCtrl->AppendItem(root, wxT("node1"));
        wxTreeItemId node2 = treeCtrl->AppendItem(root, wxT("node2"));
        wxTreeItemId node3 = treeCtrl->AppendItem(node2, wxT("node3"));
    ...
    ticpp::Element* ExportToXrc(IObject* obj) override
    {
        ObjectToXrcFilter xrc(obj, _("wxTreeCtrl"),
                              obj->GetPropertyAsString(_("name")));
        xrc.AddWindowProperties();
        return xrc.GetXrcObject();
    }
...
public:
    wxObject* Create(IObject* obj, wxObject* parent) override
    {
        ...
        scrollBar->SetScrollbar(obj->GetPropertyAsInteger(_T("value")),
    ...
    ticpp::Element* ExportToXrc(IObject* obj) override
    {
        ObjectToXrcFilter xrc(obj, _("wxScrollBar"),
                              obj->GetPropertyAsString(_("name")));
        xrc.AddWindowProperties();
...
public:
    ...
    void OnSpin(wxSpinEvent& event)
    {
        ...
        wxString value;
        value.Printf(wxT("%i"), spinCtrl->GetValue());
        GetManager()->ModifyProperty(spinCtrl, _("initial"), value);
        spinCtrl->SetFocus();
    }
    ...
    ticpp::Element* ExportToXrc(IObject* obj) override
    {
        ObjectToXrcFilter xrc(obj, _("wxSpinCtrl"),
                              obj->GetPropertyAsString(_("name")));
        xrc.AddWindowProperties();
...
public:
    wxObject* Create(IObject* obj, wxObject* parent) override
    {
        ...
        spinCtrlDouble->SetDigits(obj->GetPropertyAsInteger(_("digits")));
    ...
    void OnSpin(wxSpinEvent& event)
    {
        ...
        wxString value;
        value.Printf(wxT("%f"), spinCtrlDouble->GetValue());
        GetManager()->ModifyProperty(spinCtrlDouble, _("initial"), value);
    ...
    ticpp::Element* ExportToXrc(IObject* obj) override
    {
        ObjectToXrcFilter xrc(obj, _("wxSpinCtrlDouble"),
                              obj->GetPropertyAsString(_("name")));
        xrc.AddWindowProperties();
        xrc.AddProperty(_("initial"), _("value"), XRC_TYPE_TEXT);
        xrc.AddProperty(_("min"), _("min"), XRC_TYPE_INTEGER);
...
public:
    ...
    ticpp::Element* ExportToXrc(IObject* obj) override
    {
        ObjectToXrcFilter xrc(obj, _("wxSpinButton"),
                              obj->GetPropertyAsString(_("name")));
        xrc.AddWindowProperties();
        return xrc.GetXrcObject();
    }
...
public:
    wxObject* Create(IObject* obj, wxObject* parent) override
    {
        ...
        wxCheckListBox* chkListBox = new wxCheckListBox(
            (wxWindow*)parent, wxID_ANY,
            obj->GetPropertyAsPoint(_("pos")),
            obj->GetPropertyAsSize(_("size")), choices,
            obj->GetPropertyAsInteger(_("style"))
                | obj->GetPropertyAsInteger(_("window_style")));
    ...
    ticpp::Element* ExportToXrc(IObject* obj) override
    {
        ObjectToXrcFilter xrc(obj, _("wxCheckListBox"),
                              obj->GetPropertyAsString(_("name")));
        xrc.AddWindowProperties();
...
public:
    wxObject* Create(IObject* obj, wxObject* parent) override
    {
        ...
        grid->EnableDragColMove(obj->GetPropertyAsInteger(_("drag_col_move")));
        grid->EnableDragColSize(obj->GetPropertyAsInteger(_("drag_col_size")));
        grid->EnableDragGridSize(obj->GetPropertyAsInteger(_("drag_grid_size")));
        grid->EnableDragRowSize(obj->GetPropertyAsInteger(_("drag_row_size")));
        grid->EnableEditing(obj->GetPropertyAsInteger(_("editing")));
        grid->EnableGridLines(obj->GetPropertyAsInteger(_("grid_lines")));

        if (!obj->IsNull(_("grid_line_color")))
            grid->SetGridLineColour(obj->GetPropertyAsColour(_("grid_line_color")));

        grid->SetMargins(obj->GetPropertyAsInteger(_("margin_width")),
                         obj->GetPropertyAsInteger(_("margin_height")));

        // Label Properties
        grid->SetColLabelAlignment(obj->GetPropertyAsInteger(_("col_label_horiz_alignment")),
        ...
        grid->SetRowLabelAlignment(obj->GetPropertyAsInteger(_("row_label_horiz_alignment")),
        ...
        grid->SetDefaultCellAlignment(obj->GetPropertyAsInteger(_("cell_horiz_alignment")),
                                      obj->GetPropertyAsInteger(_("cell_vert_alignment")));
        ...
        for (int col = 0; col < grid->GetNumberCols(); ++col) {
            for (int row = 0; row < grid->GetNumberRows(); ++row) {
                grid->SetCellValue(
                    row, col, grid->GetColLabelValue(col) + wxT("-") + grid->GetRowLabelValue(row));
            }
        }
        if (obj->GetPropertyAsInteger(_("autosize_rows")))
            grid->AutoSizeRows();

        if (obj->GetPropertyAsInteger(_("autosize_cols")))
...
public:
    ...
    ticpp::Element* ExportToXrc(IObject* obj) override
    {
        ObjectToXrcFilter xrc(obj, _("wxColourPickerCtrl"),
                              obj->GetPropertyAsString(_("name")));
...
public:
    wxObject* Create(IObject* obj, wxObject* parent) override
    {
        ...
        if (!obj->IsNull(_("max_point_size")))
            fontPicker->SetMaxPointSize(obj->GetPropertyAsInteger(_("max_point_size")));
    ...
    ticpp::Element* ExportToXrc(IObject* obj) override
    {
        ObjectToXrcFilter xrc(obj, _("wxFontPickerCtrl"),
                              obj->GetPropertyAsString(_("name")));
...
public:
    ...
    ticpp::Element* ExportToXrc(IObject* obj) override
    {
        ObjectToXrcFilter xrc(obj, _("wxFilePickerCtrl"),
                              obj->GetPropertyAsString(_("name")));
        xrc.AddProperty(_("value"), _("value"), XRC_TYPE_TEXT);
...
void ComponentEvtHandler::OnFilePickerFileChanged(wxFileDirPickerEvent&)
{
    ...
    if (filePicker)
        m_manager->ModifyProperty(filePicker, _("value"), filePicker->GetPath());
}
...
public:
    ...
    ticpp::Element* ExportToXrc(IObject* obj) override
    {
        ObjectToXrcFilter xrc(obj, _("wxDirPickerCtrl"),
                              obj->GetPropertyAsString(_("name")));
...
void ComponentEvtHandler::OnDirPickerDirChanged(wxFileDirPickerEvent&)
{
    ...
    if (dirPicker)
        m_manager->ModifyProperty(dirPicker, _("value"), dirPicker->GetPath());
}
...
public:
    wxObject* Create(IObject* obj, wxObject* parent) override
    {
        ...
        if (!obj->IsNull(_("hover_color")))
            linkCtrl->SetHoverColour(obj->GetPropertyAsColour(_("hover_color")));

        if (!obj->IsNull(_("normal_color")))
            linkCtrl->SetNormalColour(obj->GetPropertyAsColour(_("normal_color")));

        if (!obj->IsNull(_("visited_color")))
            linkCtrl->SetVisitedColour(obj->GetPropertyAsColour(_("visited_color")));
    ...
    ticpp::Element* ExportToXrc(IObject* obj) override
    {
        ObjectToXrcFilter xrc(obj, _("wxHyperlinkCtrl"),
                              obj->GetPropertyAsString(_("name")));
...
public:
    wxObject* Create(IObject* obj, wxObject* parent) override
    {
        ...
        dirCtrl->ShowHidden(obj->GetPropertyAsInteger(_("show_hidden")));
    ...
    ticpp::Element* ExportToXrc(IObject* obj) override
    {
        ObjectToXrcFilter xrc(obj, _("wxGenericDirCtrl"),
                              obj->GetPropertyAsString(_("name")));
...
public:
    ...
    ticpp::Element* ExportToXrc(IObject* obj) override
    {
        ObjectToXrcFilter xrc(obj, obj->GetPropertyAsString(_("class")),
                              obj->GetPropertyAsString(_("name")));
        return xrc.GetXrcObject();
    }
};
...
public:
    wxObject* Create(IObject* obj, wxObject* parent) override
    {
        ...
        if (!obj->IsNull(_("search_button")))
            searchCtrl->ShowSearchButton(obj->GetPropertyAsInteger(_("search_button")));

        if (!obj->IsNull(_("cancel_button")))
            searchCtrl->ShowCancelButton(obj->GetPropertyAsInteger(_("cancel_button")));
    ...
    ticpp::Element* ExportToXrc(IObject* obj) override
    {
        ObjectToXrcFilter xrc(obj, _("wxSearchCtrl"),
                              obj->GetPropertyAsString(_("name")));
        xrc.AddWindowProperties();
        xrc.AddProperty(_("value"), _("value"), XRC_TYPE_TEXT);
        return xrc.GetXrcObject();
...
void ComponentEvtHandler::OnText(wxCommandEvent& event)
{
    ...
    if (searchCtrl) {
        m_manager->ModifyProperty(m_window, _("value"), searchCtrl->GetValue());
...
public:
    wxObject* Create(IObject* obj, wxObject* parent) override
    {
        ...
        if (!obj->IsNull(_("file"))) {
            if (mediaCtrl->Load(obj->GetPropertyAsString(_("file")))) {

                if (!obj->IsNull(_("playback_rate"))) {
                    mediaCtrl->SetPlaybackRate(
                        obj->GetPropertyAsFloat(_("playback_rate")));
                }
                if (!obj->IsNull(_("volume"))
                    && (obj->GetPropertyAsFloat(_("volume")) >= 0)
                    && (obj->GetPropertyAsFloat(_("volume")) <= 1))
                    mediaCtrl->SetPlaybackRate(obj->GetPropertyAsFloat(_("volume")));
    ...
    ticpp::Element* ExportToXrc(IObject* obj) override
    {
        ObjectToXrcFilter xrc(obj, _("wxMediaCtrl"),
                              obj->GetPropertyAsString(_("name")));
        xrc.AddWindowProperties();
        return xrc.GetXrcObject();
    }
...
public:
    wxObject* Create(IObject* obj, wxObject* parent) override
    {
        ...
        if (!obj->GetPropertyAsString(wxT("extra_style")).empty()) {
            propGrid->SetExtraStyle(obj->GetPropertyAsInteger(wxT("extra_style")));
        }
        return propGrid;
    }
#if 0
            ...
            if (childObj->GetPropertyAsString(_("type")) == _("Category")) {
                ...
                wxPGProperty* property = wxDynamicCast(
                    wxCreateDynamicObject(
                        wxT("wx")
                        + (childObj->GetPropertyAsString(_("type")))
                        + wxT("Property")),
                    wxPGProperty);
                if (!property)
                    continue;

                property->SetLabel(childObj->GetPropertyAsString(_("label")));
                property->SetName(childObj->GetPropertyAsString(_("label")));
                propGrid->Append(property);

                if (childObj->GetPropertyAsString(_("help")) != wxEmptyString) {
                    propGrid->SetPropertyHelpString(
                        property, childObj->GetPropertyAsString(_("help")));
                }
            }
        }
    }
...
public:
    wxObject* Create(IObject* obj, wxObject* parent) override
    {
        ...
        if (!obj->GetPropertyAsString(wxT("extra_style")).empty())
            propGridMgr->SetExtraStyle(obj->GetPropertyAsInteger(wxT("extra_style")));

        propGridMgr->ShowHeader(obj->GetPropertyAsInteger(wxT("show_header")));
#if 0
        ...
        wxPGProperty* id = pgPage->Append(
            new wxStringProperty(_("Label"), wxPG_LABEL, _("Initial Value")));

        pgPage->SetPropertyHelpString(id, _("A string property"));

        // Add int property
        pgPage->Append(new wxIntProperty(wxT("IntProperty"), wxPG_LABEL, 12345678));

        // Add float property (value type is actually double)
        pgPage->Append(new wxFloatProperty(wxT("FloatProperty"), wxPG_LABEL, 12345.678));

        // Add a bool property
        pgPage->Append(new wxBoolProperty(wxT("BoolProperty"), wxPG_LABEL, false));
        pgPage->Append(new wxBoolProperty(wxT("BoolPropertyAsCheckbox"), wxPG_LABEL, true));
        pgPage->SetPropertyAttribute(
            wxT("BoolPropertyAsCheckbox"), wxPG_BOOL_USE_CHECKBOX, (long)1);
        ...
        pgPage->Append(
            new wxEnumProperty(
                wxT("EnumProperty"), wxPG_LABEL, strings, indexes, 0));
        ...
        pgPage->Append(
            new wxLongStringProperty(
                wxT("LongStringProperty"), wxPG_LABEL,
        ...
        pgPage->Append(new wxDirProperty(
            wxT("DirProperty"), wxPG_LABEL, ::wxGetUserHome()));

        // A file selector property.
        pgPage->Append(new wxFileProperty(
            wxT("FileProperty"), wxPG_LABEL, wxEmptyString));

        wxPropertyGridPage* pgPage2 = propGridMgr->AddPage(_("Second Page"));

        pgPage2->Append(new wxPropertyCategory(_("Sample Parent Property"), wxPG_LABEL));

        wxPGProperty* carProp2 = pgPage2->Append(
            new wxStringProperty(
                _("Car"), wxPG_LABEL, wxT("<composed>")));

        pgPage2->AppendIn(
            carProp2,
            new wxStringProperty(
                _("Model"), wxPG_LABEL, wxT("Lamborghini Diablo SV")));

        pgPage2->AppendIn(
            carProp2,
            new wxIntProperty(
                _("Engine Size (cc)"), wxPG_LABEL, 5707));

        wxPGProperty* speedsProp2 = pgPage2->AppendIn(
            carProp2,
            new wxStringProperty(_("Speeds"), wxPG_LABEL,
                                 wxT("<composed>")));

        pgPage2->AppendIn(speedsProp2,
                          new wxIntProperty(_("Max. Speed (mph)"), wxPG_LABEL,
                                            300));
        pgPage2->AppendIn(speedsProp2,
                          new wxFloatProperty(_("0-100 mph (sec)"), wxPG_LABEL,
                                              3.9));
        pgPage2->AppendIn(speedsProp2,
                          new wxFloatProperty(_("1/4 mile (sec)"), wxPG_LABEL,
                                              8.6));

        pgPage2->AppendIn(carProp2,
                          new wxIntProperty(_("Price ($)"), wxPG_LABEL,
                                            300000));

        if (obj->GetPropertyAsInteger(wxT("include_advanced"))) {
            pgPage2->Append(
                new wxPropertyCategory(_("Advanced Properties"), wxPG_LABEL));

            // wxArrayStringProperty embeds a wxArrayString.
            pgPage2->Append(
                new wxArrayStringProperty(_("Example of ArrayStringProperty"),
                                          wxT("ArrayStringProp")));

            // Image file property. Wildcard is auto-generated from available
            // image handlers, so it is not set this time.
            pgPage2->Append(
                new wxImageFileProperty(_("Example of ImageFileProperty"),
                                        wxT("ImageFileProp")));

            // Font property has sub-properties.
            pgPage2->Append(
                new wxFontProperty(_("Font"), wxPG_LABEL));

            // Colour property with arbitrary colour.
            pgPage2->Append(
                new wxColourProperty(_("My Colour 1"), wxPG_LABEL,
                                     wxColour(242, 109, 0)));

            // System colour property.
            pgPage2->Append(
                new wxSystemColourProperty(
                    _("My SysColour 1"), wxPG_LABEL,
                        wxSystemSettings::GetColour(wxSYS_COLOUR_WINDOW)));

            // System colour property with custom colour.
            pgPage2->Append(
                new wxSystemColourProperty(
                    _("My SysColour 2"), wxPG_LABEL, wxColour(0, 200, 160)));

            // Cursor property
            pgPage2->Append(
                new wxCursorProperty(
                    _("My Cursor"), wxPG_LABEL,  wxCURSOR_ARROW));
        }
#endif
        return propGridMgr;
    }
    ...
    void OnCreated(wxObject* wxobject, wxWindow* /*wxparent*/) override
    {
        wxPropertyGridManager* propGridMgr = wxDynamicCast(wxobject, wxPropertyGridManager);
        if (!propGridMgr)
            return;
            ...
            for (size_t j = 0; j < childObj->GetChildCount(); ++j) {
                ...
                if (innerChildObj->GetPropertyAsString(_("type")) == _("Category")) {
                    ...
                    wxPGProperty* property = wxDynamicCast(
                        wxCreateDynamicObject(
                            wxT("wx")
                            + (innerChildObj->GetPropertyAsString(_("type")))
                            + wxT("Property")),
                        wxPGProperty);
                    if (!property)
                        continue;

                    property->SetLabel(innerChildObj->GetPropertyAsString(_("label")));
                    property->SetName(innerChildObj->GetPropertyAsString(_("label")));
                    page->Append(property);

                    if (innerChildObj->GetPropertyAsString(_("help"))
                        != wxEmptyString) {
                        page->SetPropertyHelpString(
                            property,
                            innerChildObj->GetPropertyAsString(_("help")));
                    }
                }
            }
        }
...
public:
    wxObject* Create(IObject* obj, wxObject* parent) override
    {
        ...
        // Line Numbers
        if (obj->GetPropertyAsInteger(_("line_numbers"))) {
            styledTextCtrl->SetMarginType(0, wxSTC_MARGIN_NUMBER);
            styledTextCtrl->SetMarginWidth(
                0, styledTextCtrl->TextWidth(wxSTC_STYLE_LINENUMBER, wxT("_99999")));
        } else {
            styledTextCtrl->SetMarginWidth(0, 0);
        }
        // markers
        styledTextCtrl->MarkerDefine(wxSTC_MARKNUM_FOLDER, wxSTC_MARK_BOXPLUS);
        styledTextCtrl->MarkerSetBackground(wxSTC_MARKNUM_FOLDER, wxColour(wxT("BLACK")));
        styledTextCtrl->MarkerSetForeground(wxSTC_MARKNUM_FOLDER, wxColour(wxT("WHITE")));
        styledTextCtrl->MarkerDefine(wxSTC_MARKNUM_FOLDEROPEN, wxSTC_MARK_BOXMINUS);
        styledTextCtrl->MarkerSetBackground(wxSTC_MARKNUM_FOLDEROPEN, wxColour(wxT("BLACK")));
        styledTextCtrl->MarkerSetForeground(wxSTC_MARKNUM_FOLDEROPEN, wxColour(wxT("WHITE")));
        ...
        styledTextCtrl->MarkerSetBackground(wxSTC_MARKNUM_FOLDEREND, wxColour(wxT("BLACK")));
        styledTextCtrl->MarkerSetForeground(wxSTC_MARKNUM_FOLDEREND, wxColour(wxT("WHITE")));
        styledTextCtrl->MarkerDefine(wxSTC_MARKNUM_FOLDEROPENMID, wxSTC_MARK_BOXMINUS);
        styledTextCtrl->MarkerSetBackground(wxSTC_MARKNUM_FOLDEROPENMID, wxColour(wxT("BLACK")));
        styledTextCtrl->MarkerSetForeground(wxSTC_MARKNUM_FOLDEROPENMID, wxColour(wxT("WHITE")));
        ...
        // folding
        if (obj->GetPropertyAsInteger(_("folding"))) {
        ...
        styledTextCtrl->SetIndentationGuides(obj->GetPropertyAsInteger(_("indentation_guides")));
        ...
        styledTextCtrl->SetUseTabs((obj->GetPropertyAsInteger(_("use_tabs"))));
        styledTextCtrl->SetTabWidth(obj->GetPropertyAsInteger(_("tab_width")));
        styledTextCtrl->SetTabIndents((obj->GetPropertyAsInteger(_("tab_indents"))));
        styledTextCtrl->SetBackSpaceUnIndents((obj->GetPropertyAsInteger(_("backspace_unindents"))));
        styledTextCtrl->SetIndent(obj->GetPropertyAsInteger(_("tab_width")));
        ...
        styledTextCtrl->SetViewEOL((obj->GetPropertyAsInteger(_("view_eol"))));
        styledTextCtrl->SetViewWhiteSpace(obj->GetPropertyAsInteger(_("view_whitespace")));
        styledTextCtrl->SetCaretWidth(2);
        styledTextCtrl->SetText(wxT("/** Sample Class to Display wxScintilla */\n")
            ...
            if (childObj->GetPropertyAsString(_("type")) == _("Text")) {
                auto* col = list->AppendTextColumn(
                    ...
                    static_cast<wxDataViewCellMode>(
                        childObj->GetPropertyAsInteger(_("mode"))),
                    childObj->GetPropertyAsInteger(_("width")),
                    static_cast<wxAlignment>(
                        childObj->GetPropertyAsInteger(_("align"))),
                ...
                if (!childObj->IsNull(_("ellipsize"))) {
                    col->GetRenderer()->EnableEllipsize(
                        static_cast<wxEllipsizeMode>(
                            childObj->GetPropertyAsInteger(_("ellipsize"))));
                }
...
public:
    ...
    void OnCreated(wxObject* wxobject, wxWindow* /*wxparent*/) override
    {
        ...
        for (int i = 0; i < 5; ++i) {
            treeListItem = treeListCtrl->AppendItem(
                treeListParent, wxString::Format(_("Item #%d"), ++n));
    ...
    void FillItem(wxTreeListCtrl* treeListCtrl, wxTreeListItem itemId, int colCount, int row)
    {
        for (int i = 0; i < colCount; ++i) {
            treeListCtrl->SetItemText(
                itemId, i, wxString::Format(_("Item #%d, column #%d"), row, i));
        }
    }
};
...
public:
    void OnCreated(wxObject* wxobject, wxWindow* wxparent) override
    {
        ...
        if (!(obj && treeList)) {
            wxLogError(_("TreeListCtrlColumnComponent is missing"
...
class RibbonPageComponent : public ComponentBase {
    ...
    wxObject* Create(IObject* obj, wxObject* parent) override
    {
        wxRibbonPage* rbpage = new wxRibbonPage(
            ...
            obj->GetPropertyAsString(_("label")),
            obj->GetPropertyAsBitmap(_("bitmap")), 0);
...
class RibbonButtonBarComponent : public ComponentBase {
    ...
    wxObject* Create(IObject* obj, wxObject* parent) override
    {
        wxRibbonButtonBar* ribbonBtnBar = new wxRibbonButtonBar(
            ...
            obj->GetPropertyAsPoint(_("pos")),
            obj->GetPropertyAsSize(_("size")), 0);
#if 0
        ...
        for (size_t i = 0; i < count; ++i) {
            ...
            if (wxT("ribbonGalleryItem") == childObj->GetClassName()) {
                ribbonGallery->Append(
                    childObj->GetPropertyAsBitmap(_("bitmap")), wxID_ANY);
            }
        }
    }
};
