...
wxToolBar* MainFrame::CreateWeaverToolBar()
{
    ...
    toolbar->AddSeparator();
    toolbar->AddTool(ID_ALIGN_LEFT, "", AppBitmaps::GetBitmap("align-horizontal-left", TOOL_SIZE), wxNullBitmap, wxITEM_CHECK, _("Align Left"), _("The item will be aligned to the left of the space allotted to it by the sizer."));
    toolbar->AddTool(ID_ALIGN_CENTER_H, "", AppBitmaps::GetBitmap("align-horizontal-center", TOOL_SIZE), wxNullBitmap, wxITEM_CHECK, _("Align Center Horizontally"), _("The item will be centered horizontally in the space allotted to it by the sizer."));
    toolbar->AddTool(ID_ALIGN_RIGHT, "", AppBitmaps::GetBitmap("align-horizontal-right", TOOL_SIZE), wxNullBitmap, wxITEM_CHECK, _("Align Right"), _("The item will be aligned to the right of the space allotted to it by the sizer."));
    toolbar->AddSeparator();
    toolbar->AddTool(ID_ALIGN_TOP, "", AppBitmaps::GetBitmap("align-vertical-top", TOOL_SIZE), wxNullBitmap, wxITEM_CHECK, _("Align Top"), _("The item will be aligned to the top of the space allotted to it by the sizer."));
    toolbar->AddTool(ID_ALIGN_CENTER_V, "", AppBitmaps::GetBitmap("align-vertical-center", TOOL_SIZE), wxNullBitmap, wxITEM_CHECK, _("Align Center Vertically"), _("The item will be centered vertically within space allotted to it by the sizer."));
    toolbar->AddTool(ID_ALIGN_BOTTOM, "", AppBitmaps::GetBitmap("align-vertical-bottom", TOOL_SIZE), wxNullBitmap, wxITEM_CHECK, _("Align Bottom"), _("The item will be aligned to the bottom of the space allotted to it by the sizer."));
    toolbar->AddSeparator();
    toolbar->AddTool(ID_EXPAND, "", AppBitmaps::GetBitmap("size-expand", TOOL_SIZE), wxNullBitmap, wxITEM_CHECK, _("Expand (Alt+W)"), _("The item will be expanded to fill the space assigned to the item."));
