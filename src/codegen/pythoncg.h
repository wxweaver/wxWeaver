...
public:
    PythonTemplateParser(PObjectBase obj, wxString _template,
                         bool useI18N, bool useRelativePath, wxString basePath,
                         wxString imagePathWrapperFunctionName);

    PythonTemplateParser(const PythonTemplateParser& other, wxString _template);
...
public:
    ...
    */
    ...
    /** Configures the function name,
        image paths should be wrapped into when generating python code.
...
private:
    ...
    */
    void FindDependencies(PObjectBase obj, std::set<PObjectInfo>& infoSet);
    ...
    */
    bool GenEventEntry(PObjectBase obj, PObjectInfo objInfo,
