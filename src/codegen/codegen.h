...
/** Preprocessor directives:
  ...
  - #wxparent $property
    ...
    This directive is necessary to generate the parameter "wxWindow  parent"
    in the constructors of each widget.
  ...
  - #foreach $property @{ ..... @}
    Used to repeat code for each subproperty of $property, where $property
    is a comma delimited list.
    The code is contained between '@{' and '@}'. The code will be generated
    as many times as there are subexpressions in the value of the property.
    Within the brace, access to the subexpression is obtained with the #pred
    directive, and access to index of the subexpression is obtained with #npred.
...
public:
    ...
    */
    ...
    /** This method creates a new parser with the same type that the object
        calling such method.
    */
    virtual PTemplateParser CreateParser(
        const TemplateParser* oldparser,
        wxString _template)
        = 0;
